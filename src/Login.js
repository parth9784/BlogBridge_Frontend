...
export default function LoginPage() {
    ...
    return (
        <div className="bg-white w-screen h-screen flex items-center justify-around">
            <form onSubmit={handleSubmit} className="w-[400px] bg-gray-100 flex flex-col items-center gap-9 rounded-lg">
                <header>
